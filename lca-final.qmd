...
alum_base_scen <- aluminium_sheet %>% 
  slice(3:14) %>%
  select(x4:x20) %>%
  mutate(row_id = row_number()) %>%
  mutate(across(x4:x20, 
...
alum_truck0 <- aluminium_sheet %>% 
  ...
  mutate(scenario = "truck_0")

# set up truck_100 scenario absolute values
alum_truck100 <- aluminium_sheet %>% 
  slice(66:78) %>%
  select(x4:x20) %>%
  mutate(row_id = row_number()) %>%
  mutate(across(x4:x20, 
  ...
  mutate(scenario = "truck_100")


# set up recycling_0 scenario absolute values
alum_recycling0 <- aluminium_sheet %>% 
  slice(98:109) %>%
  select(x4:x20) %>%
  mutate(row_id = row_number()) %>%
  mutate(across(x4:x20, 
  ...
  mutate(scenario = "recycling_0")


# set up recycling_100 scenario absolute values
alum_recycling100 <- aluminium_sheet %>% 
  slice(130:141) %>%
  select(x4:x20) %>%
  mutate(row_id = row_number()) %>%
  mutate(across(x4:x20, 
...
# set up bottle_mass_370 scenario absolute values
glass_mass_370 <- glass_sheet %>% 
  slice(110:121) %>%
  select(x4:x19) %>%
  mutate(row_id = row_number()) %>%
  mutate(across(x4:x19, 
