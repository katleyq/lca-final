...
ggplot(normalized_total_impact, aes(x = impact_type, y = normalized_value, fill = container)) +
  ...
  # Replace scale_fill_discrete with scale_fill_manual to set custom colors
  scale_fill_manual(
    values = c(
      "aluminium_normalized" = "navy",
      "glass_normalized" = "darkred",
      "PET_normalized" = "gold"
    ),
    labels = c(
...
containers %>% 
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "none") +
  scale_fill_manual(values = c("production" = "darkgreen", 
